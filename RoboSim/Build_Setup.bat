...
xcopy /Y "%CD%\imgui_backup_Original.ini" "%CD%\..\x64\Debug\" 
xcopy /Y "%CD%\config.ini" "%CD%\..\x64\Debug\" 
...
xcopy /Y "%CD%\imgui_backup_Original.ini" "%CD%\..\x64\Release\" 
xcopy /Y "%CD%\config.ini" "%CD%\..\x64\Release\" 
